...
while camera.isOpened():
    ...
    if isBgCaptured == 1:
        ...
        if prediction[0][0]=='ONE':
            def zero():
                time.sleep(2)
                cords = pyautogui.locateCenterOnScreen('img/1.png')
        ...
        if prediction[0][0]=='TWO':
            def two():
                time.sleep(2)
                cords = pyautogui.locateCenterOnScreen('img/s2.png')
                pyautogui.click(cords)
            two()
        ...
        if prediction[0][0]=='THREE':
            def three():
                time.sleep(2)
                cords = pyautogui.locateCenterOnScreen('img/t3.png')
                pyautogui.click(cords)
            three()
        ...
        if prediction[0][0]=='FOUR':
            def four():
                time.sleep(2)
                cords = pyautogui.locateCenterOnScreen('img/p1.png')
                pyautogui.click(cords)
            four()
